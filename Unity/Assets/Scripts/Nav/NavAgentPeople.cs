...
public class NavAgentPeople : MonoBehaviour
{
    private NavAgent<NavAgentPeople> _navAgent;
    ...
    void Start()
    {
        _navAgent = new NavAgent<NavAgentPeople>(gameObject, new FiniteStateMachine<NavAgentPeople>(gameObject));
